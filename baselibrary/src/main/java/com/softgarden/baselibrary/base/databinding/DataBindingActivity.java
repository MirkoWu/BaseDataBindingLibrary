...
public abstract class DataBindingActivity<B extends ViewDataBinding> extends RxAppCompatActivity implements BaseDisplay {
...
//        if (mNightMode) AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES);
    ...
    public void initContentView() {
        ...
        if (commonToolbar != null) {
            ...
            setContentView(view);
            setSupportActionBar(commonToolbar);//这里才是真的将toolbar设置为actionbar 否则它只是一个布局而已
